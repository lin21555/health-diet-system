...
const routes = [
  ...
  { path: '/activity/:id', component: () => import('../views/front/ActivityDetail.vue') },
  ...
  { path: '/user', component: () => import('../views/front/UserCenter.vue') },
  {
    ...
    children: [
      ...
      { path: 'activities', component: () => import('../views/admin/ActivityManage.vue'), meta: { title: '健康活动管理', requiresAdmin: true } },
